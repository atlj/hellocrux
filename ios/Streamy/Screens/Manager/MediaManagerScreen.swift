...
#Preview {
    MediaManagerScreen(
        ...
        ], overrideMediaItems: .success(data: ["Idiocracy": .init(id: "Idiocracy", metadata: .init(thumbnail: "https://www.themoviedb.org/t/p/w1280/k75tEyoPbPlfHSKakJBOR5dx1Dp.jpg", title: "Idiocracy"), content: .movie(.init(media: "", track_name: "", subtitle_paths: [])))]),
